...
class AvazuDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset_path=None, cache_path='.avazu', rebuild_cache=False, min_threshold=5):
        # We omit the hour field.
        self.NUM_FEATS = 22
        self.min_threshold = min_threshold
        # self.prefix = "./data/avazu/"
        #  the path of avazu dataset.
        self.prefix = "../data/avazu/"
...
def get_avazu_dataloader_811(train_path="train", batch_size=4096):
    ...
    # train
    train_dataset = AvazuDataset(dataset_path=train_path,
                                 cache_path="/.avazu_train5",
                                 rebuild_cache=False, min_threshold=5)
    field_dims = train_dataset.field_dims
    print(field_dims)  # 1544488 min_threshold=5
    all_length = len(train_dataset)

    # 8:1:1
    valid_size = int(0.1 * all_length)
    train_size = all_length - valid_size
    print("test&valid:", valid_size)
    ...
    # print("valid_size:",len(valid_dataset)) 4042896
    # print("test_size:",len(test_dataset)) 4042896
    # print("train_size",len(train_dataset)) 32343175
